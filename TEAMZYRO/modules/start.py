...
➺ ᴜᴘᴛɪᴍᴇ: {uptime}"""
    ...
    buttons = [
        ...
        [InlineKeyboardButton("❍sᴜᴘᴘᴏʀᴛ❍", url="https://t.me/snowy_hometown"), 
         InlineKeyboardButton("❍ᴄʜᴀɴɴᴇʟ❍", url="https://t.me/dark_musictm")],
        [InlineKeyboardButton("⋆ʜᴇʟᴘ⋆", callback_data="open_help")],
        [InlineKeyboardButton("✦ʟᴏʀᴅ✦", url="http://t.me/uchiha_owner")]
    ]
...
async def generate_group_start_message(client):
    ...
    buttons = [
        [
            ...
            InlineKeyboardButton("◦sᴜᴘᴘᴏʀᴛ◦", url="https://t.me/hometown_support"),
        ]
    ]
    return caption, buttons
